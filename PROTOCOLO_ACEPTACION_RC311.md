# Protocolo de aceptación — ThermalBridge 0.7.0 RC3.11

## Regla de la candidata

RC3.11 es una versión congelada. Si se modifica cualquier fuente después de iniciar este protocolo, el resultado deja de pertenecer a RC3.11 y debe publicarse como una nueva candidata o volver a beta.
...
3. Ejecuta `Instalar_en_Aplicaciones.command` desde RC3.11.
...
Mantén RC3.11 instalada durante al menos tres sesiones reales adicionales o 24 horas de uso normal, lo que ocurra después. Registra:
