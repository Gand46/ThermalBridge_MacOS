# Subir ThermalBridge RC3.10 a GitHub

Este paquete está preparado para usarse como raíz de un repositorio. Conserva las fuentes congeladas de **ThermalBridge 0.7.0 RC3.10 build 37** y los archivos mínimos de colaboración y comprobación para GitHub.
...
git init -b main
git add .
git commit -m "Publicar ThermalBridge 0.7.0 RC3.10 build 37"
...
- los manifiestos SHA-256 de Beta 6 y RC3.10;
