# Subir ThermalBridge RC3.9 a GitHub

Este paquete está preparado para usarse como raíz de un repositorio. Conserva las fuentes congeladas de **ThermalBridge 0.7.0 RC3.9 build 36** y los archivos mínimos de colaboración y comprobación para GitHub.
...
git init -b main
git add .
git commit -m "Publicar ThermalBridge 0.7.0 RC3.9 build 36"
...
- los manifiestos SHA-256 de Beta 6 y RC3.9;
