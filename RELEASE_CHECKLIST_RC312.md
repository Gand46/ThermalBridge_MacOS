...
- [x] Fuentes, pruebas, scripts operativos, documentación de release y configuración incluidos en `RC312_FROZEN_SHA256.txt`.
...
- [x] Etapa B1 iniciada con analizador offline de telemetría JSONL.

## Validación nativa pendiente para build 39
...
- Cualquier hash RC3.12 distinto.
