# Release checklist — RC3.11

## Completado en preparación

- [x] Base inmediata RC3.10 build 37.
- [x] Build incrementado a 38 para preselección por CPU del `.exe` más demandante.
...
- [x] Fuentes, pruebas, scripts operativos, documentación de release y configuración incluidos en `RC311_FROZEN_SHA256.txt`.
...
## Validación nativa pendiente para build 38
...
- Cualquier hash RC3.11 distinto.
