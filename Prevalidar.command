...
grep -q '<string>33</string>' Resources/Info.plist || fail "CFBundleVersion debe ser 33"
grep -q 'ThermalBridge Auto 0.7.0 RC3.6' README.md || fail "README no declara RC3.6"
grep -q 'VALIDACIÓN COMPLETADA: ThermalBridge 0.7.0 RC3.6 (33)' README.md || fail "README no documenta la validación RC3.6"

printf '[2/7] Verificando manifiestos congelados...\n'
sha_check BASELINE_BETA6_SHA256.txt
sha_check RC36_FROZEN_SHA256.txt
...
printf 'PREVALIDACIÓN COMPLETADA: ThermalBridge 0.7.0 RC3.6 (33)\n'
