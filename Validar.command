...
grep -q 'modo sombra: sin SIGSTOP/SIGCONT fuera de emergencia' "$ROOT_DIR/Sources/AutomaticThermalSupport.swift"
grep -q 'B1PredictiveThermalGovernor' "$ROOT_DIR/Sources/B1PredictiveThermalGovernor.swift"
grep -q 'observed_only_no_sigstop' "$ROOT_DIR/Sources/B1PredictiveThermalGovernor.swift"
